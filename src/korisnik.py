...
def login(): #funkcija za login
    while True:
        ...
        for korisnik in korisnici: #prolazak kroz listu svih korisnika
            if korisnicko_ime == korisnik["korisnicko_ime"] and sifra == korisnik["sifra"]: #proveravanje postojanja korisnika u listi korisnika
            ...
            print("Korisnicko ime i/ili lozinka nisu pronadjeni!") #slucaj da j
